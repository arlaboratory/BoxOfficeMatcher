 ...
 */
-(void)QRCodeFound:(NSString*)code;
 ...
 */
-(void)QRCodesFoundinRois:(NSArray*)codes;

@end

@interface cvSDK : UIViewController <CameraCaptureDelegate> {
 ...
 */
@property (assign, nonatomic) CGRect ImageMatcherCropRect;

/**
 *  Callback delegate.
 */
@property (weak, nonatomic) id <matcherProtocol> delegate;
